<template>
  <div data-testid="checkout-payment" class="md:px-4 py-6">
    <fieldset>
      <legend class="text-neutral-900 typography-headline-4 font-semibold mb-4">
        {{ $t('checkoutPayment.heading') }}
      </legend>
      <slot />
      <div class="grid gap-4 grid-cols-2">
        <label
          v-for="{ value, disabled, imgSrc, imgAlt } in paymentMethods"
          :key="value"
        ...
        >
          ...
          >
            ...
            <img v-else :src="imgSrc" :alt="imgAlt" width="104" height="32" />
